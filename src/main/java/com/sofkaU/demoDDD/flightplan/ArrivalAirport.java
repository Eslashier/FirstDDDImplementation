...
public class ArrivalAirport extends AggregateEvent<AirportId> {

    protected Runaway runaway;
    protected AirTrafficFrequency airTrafficFrequency;

    public ArrivalAirport(AirportId entityId, Runaway runaway, AirTrafficFrequency airTrafficFrequency) {
        super(entityId);
