...
public class UpdateDepartureAirTrafficFrequency extends Command {
    ...
    public UpdateDepartureAirTrafficFrequency(FlightPlanId flightPlanId, AirportId airportId, AirTrafficFrequency airTrafficFrequency) {
