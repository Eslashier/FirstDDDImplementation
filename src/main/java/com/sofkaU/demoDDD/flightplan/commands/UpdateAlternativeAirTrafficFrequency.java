...
public class UpdateAlternativeAirTrafficFrequency extends Command {
    ...
    public UpdateAlternativeAirTrafficFrequency(FlightPlanId flightPlanId, AirportId airportId, AirTrafficFrequency airTrafficFrequency) {
