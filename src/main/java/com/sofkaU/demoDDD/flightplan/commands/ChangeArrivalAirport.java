...
public class ChangeArrivalAirport extends Command {
    ...
    public ChangeArrivalAirport(FlightPlanId flightPlanId, AirportId airportId, Runaway runaway, AirTrafficFrequency airTrafficFrequency) {
