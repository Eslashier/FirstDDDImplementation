...
public class ChangeDepartureAirport extends Command {
    ...
    public ChangeDepartureAirport(FlightPlanId flightPlanId, AirportId airportId, Runaway runaway, AirTrafficFrequency airTrafficFrequency) {
