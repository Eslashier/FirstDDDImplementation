...
public class DepartureAirportRunawayUpdated extends DomainEvent {
    private final AirportId airportId;
    private final Runaway runaway;

    public DepartureAirportRunawayUpdated(AirportId airportId, Runaway runaway){
        super("airways.flightplan.departureairportrunawayupdated");
